package com.example.hacker.police;
...
public class Main {
    ...
    private static class Vault{
        ...
        public boolean isCorrectPasswor(int guess){
            try {
                Thread.sleep(5);
    ...
    private static class AscendingHackerThread extends Hacker{
        ...
        public void run(){
            for (int guess=0;guess<MAX_PASSWORD;guess++){
                if(vault.isCorrectPasswor(guess)){
    ...
    private static class DecendingHackerThread extends Hacker{
